    ...
    public class WaterFXPassImpl : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderer renderer, ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingSample(cmd, k_RenderWaterFXTag))
            {
                ...
                DrawRendererSettings drawSettings = CreateDrawRendererSettings(renderingData.cameraData.camera, SortFlags.CommonTransparent, RendererConfiguration.None, renderingData.supportsDynamicBatching);
